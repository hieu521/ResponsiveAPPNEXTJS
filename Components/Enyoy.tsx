...
function Enyoy() {
  return (
    <div className="text-center py-8">
      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-6 lg:flex-nowrap lg:overflow-visible gap-4 max-w-5xl mx-auto px-4 xs:flex xs:overflow-x-auto xs:snap-x xxs:flex xxs:overflow-x-auto xxs:snap-x scrollbar-hide">
        <div className="xs:flex-col xxs:flex-col min-w-[280px] lg:flex-row bg-gradient-to-r from-[#FF0000]/40 to-[#FF0000]/0 rounded-tl-[50px] rounded-bl-[50px] p-6 flex items-start text-left overflow-hidden snap-start">
          <img
            src="/flash.png"
            alt="Instant Transactions"
            className="h-36 mb-4 w-48 xxs:w-40"
          />
          <div>
