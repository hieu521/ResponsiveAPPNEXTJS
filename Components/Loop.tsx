...
function Loop() {
  return (
    ...
    >
      <div id="letter" className="xs:hidden xxs: hidden lg:block">
        <img
      ...
      <div id="content" className="flex flex-col w-full items-center justify-center">
  <img
    className="w-5/12 lg:hidden xs:block"
    src="/letter.png"
    alt="anh"
  />
  <h1 className="xs:text-4xl text-center md:text-4xl font-bold mb-5" style={{

textShadow: '4px 4px 8px rgba(0, 0, 0, 0.7)',
}}>
    <p> Stay in the Loop</p>
  </h1>
  <p className="lg:text-center xs:text-left mb-5 text-center">
  ...
  <div className="flex flex-col  lg:flex-row items-center justify-center mb-5 space-y-2 lg:space-y-0 lg:space-x-3">
    ...
    <p className="lg:text-center xs:text-left mb-5 text-center  xxs:text-sm">example@aceloungeclub.com</p>
  </div>

  <div className="h-12 my-5 w-full max-w-lg">
  ...
  <div className="h-52 my-5 w-full max-w-lg">
  ...
  <div className="flex justify-center w-full max-w-lg">
    ...
    >
      ...
      <div id="money" className="xs:hidden xxs:hidden smd:hidden lg:block ">
        <img
